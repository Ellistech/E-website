...
export default function CheckoutShipping1() {
  return (
    <react.Fragment>
              ...
              <table class="table table-cart">
                ...
                <tbody>
                  <tr class="product-row">
                    ...
                    <td>
                      <input
                        class="vertical-quantity form-control"
                        type="text"
                      />
                    </td>
                    <td>$17.90</td>
                  ...
                  <tr>
                    <td colspan="4" class="clearfix">
                      ...
                      <div class="float-right">
                        ...
                        <a
                          href="#"
                          class="btn btn-outline-secondary btn-update-cart"
                        >
                  ...
                  <div class="form-group form-group-custom-control">
                    ...
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="best-rate"
                      />
                      <label class="custom-control-label" for="best-rate">
                        Table Rate $15.00
                      </label>
                    </div>
                  </div>
