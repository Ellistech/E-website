export default function () {
  return (
    <section
      class="home-products-intro bg-grey"
      id="specialOffer"
      style={{ padding: "4.5rem 0 2rem;" }}
    >
      <div class="container">
        <div class="row">
          <div class="col-xl-4">
            ...
            <div
              class="banner-product mt-3"
              style={{
                backgroundImage:
                  "url('assets/images/products/product-special.jpg')",
              }}
            >
